                ...
                <div className="max-w-screen-lg mx-auto py-1 ">
                    <ul className="flex justify-end items-center">
                        <li className={cx('topbar-item')}>
                            <img src="./public/images/header/icon_promotion25.png" alt="Tin mới" />
                            <a href="" className={cx('topbar-link')}>
                                TIN MỚI & ƯU ĐÃI
                            </a>
                        </li>
                        <li className={cx('topbar-item')}>
                            <img src="./public/images/header/icon_ticket25.png" alt="Vé của tôi" />
                            <a href="" className={cx('topbar-link')}>
                                VÉ CỦA TÔI
                            </a>
                        </li>
                        <li className={cx('topbar-item')}>
                            <img src="./public/images/header/icon_login25.png" alt="Login" />
                            <a href="" className={cx('topbar-link')}>
                                ĐĂNG NHẬP
                            </a>
